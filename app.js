...
const sessionAuthenticationMiddleware = (AccessToken,req, res,next) => {
...
app.use(['/users','/super_admin','/admin'], jwt(), sessionAuthenticationMiddleware);
...
app.use('/users',checkRole('ROLE_USER'),authRouter);
